...
**1. Làm thế nào để xác định và dự báo được nguy cơ giao hàng trễ (delay_min > 0) đối với các dịch vụ giao hàng nhanh 3h và 5h của UDS trong các điều kiện mưa lớn (lượng mưa > 5mm) tại khu vực có nguy cơ ngập lụt tại TP.HCM? giai đoạn 2023-2024?**
...
**2. Mối quan hệ giữa lượng mưa, mức độ ngập lụt và tình trạng ùn tắc giao thông ảnh hưởng như thế nào đến thu nhập của tài xế?**
