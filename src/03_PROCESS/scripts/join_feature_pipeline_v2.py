...
# STEP 2: TEMPORAL JOIN theo hour_timestamp
...
# Doi ten hour_timestamp cua weather truoc khi join de tranh ambiguous
df_weather_j = df_weather.withColumnRenamed("hour_timestamp", "weather_hour_timestamp")

# Left Join: giu toan bo don hang, ke ca khi khong co du lieu thoi tiet
df_joined = df_orders.join(
    df_weather_j,
    df_orders["hour_timestamp"] == df_weather_j["weather_hour_timestamp"],
    how="left"
).drop("weather_hour_timestamp")
